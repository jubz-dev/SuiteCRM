...
class getIndexControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator..fb92ez'] ?? $container->load('get_ServiceLocator__Fb92ezService'))->withContext('App\\Engine\\Controller\\IndexController', $container));
